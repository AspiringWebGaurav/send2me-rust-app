...
pub fn is_placeholder_display_name(name: &str) -> bool {
    ...
    trimmed.is_empty()
        || trimmed.eq_ignore_ascii_case("sendme")
        || trimmed.eq_ignore_ascii_case("sendme device")
        || trimmed.eq_ignore_ascii_case("send2me")
        || trimmed.eq_ignore_ascii_case("send2me device")
...
mod tests {
    ...
    fn placeholder_display_names() {
        ...
        assert!(is_placeholder_display_name("  "));
        assert!(is_placeholder_display_name("sendme"));
        assert!(is_placeholder_display_name("Sendme Device"));
        assert!(is_placeholder_display_name("send2me"));
        assert!(is_placeholder_display_name("Send2Me Device"));
